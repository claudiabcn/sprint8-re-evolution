...
export const ENTITY_LOCATIONS: Record<string, { address: string; lat: number; lng: number }> = {
  ...
  'Cos & Essència':{ address: 'Carrer Gran de Sant Andreu, 418, Barcelona', lat: 41.4403, lng: 2.1886 },
  ...
  'Fde Fisio':     { address: 'Carrer de Lanzarote, 6, Barcelona',          lat: 41.4382, lng: 2.1901 },
  'MyFisio':       { address: 'Carrer de Provença, 175, Barcelona',         lat: 41.3907, lng: 2.1557 },

  // Cita médica (todas en Vall d'Hebron)
  ...
  'General':       { address: "Hospital Vall d'Hebron, Barcelona",          lat: 41.4282, lng: 2.1409 },
  ...
  'Flexi':         { address: 'Centre Cívic Sagrada Família, Barcelona',    lat: 41.4056, lng: 2.1765 },
  'Dirigida':      { address: 'Piscina Can Dragó, Barcelona',               lat: 41.4362, lng: 2.1833 },
  'Piscina':       { address: 'Piscina Can Dragó, Barcelona',               lat: 41.4362, lng: 2.1833 },
  'Fuerza':        { address: 'Piscina Can Dragó, Barcelona',               lat: 41.4362, lng: 2.1833 },
};
